// tailwind.config.js
const spacingRem = Array.from({ length: 50 }, (_, i) => i * 0.5).reduce(
  (acc, val) => {
    acc[val.toString()] = `${val}rem`;
    return acc;
  },
  {}
);
...
const colors = require("tailwindcss/colors"); // Tailwind v4: 색상 직접 등록 필요

/** @type {import('tailwindcss').Config} */
module.exports = {
  content: ["./index.html", "./src/**/*.{html,js,ts,jsx,tsx,vue,md}"],
  theme: {
    extend: {
      height: spacingRem,
      width: spacingRem,
      ...
      colors: {
        ...colors, // ✅ 기본 색상 팔레트 복원 (blue-500 등 가능)
